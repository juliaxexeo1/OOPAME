...
def menusecundario():
    print("MENU TURMAS") 
    print(" Escolha uma opção:\n\n -OPÇÃO 1:Para cadastrar uma nova turma digite 1\n ")
    print(" -OPÇÃO 2: Para designar um professor para uma turma digite 2 \n\n -OPÇÃO 3: Para adicionar alunos em uma turma digite 3\n")
    print(" -OPÇÃO 4: Para remover alunos de uma turma digite 4 \n\n -OPÇÃO 5: Para dar a nota final a todos alunos de uma turma digite 5\n")
    print(" -OPÇÃO 6: Para mostrar todos os alunos de uma turma digite 6 \n\n -OPÇÃO 7:Para mostrar todas as turmas cadastradas digite 7\n")
    print(" -VOLTAR: caso deseje voltar ao menu principal digite 0\n")
...
#MENU PRINCIPAL
def menuprincipal():
    print("MENU PRINCIPAL\nEscolha uma opção:\n\nOPÇÃO 1 -Para cadastrar uma nova matéria digite 1\n ")
    print("OPÇÃO 2 -Para cadastrar um novo professor digite 2 \n\nOPÇÃO 3 -Para cadastrar um novo aluno digite 3\n")
    print("OPÇÃO 4 -Para mostrar todas as matérias digite 4 \n\nOPÇÃO 5 -Para mostrar todos os professores digite 5\n")
    print ("OPÇÃO 6 -Para mostrar todos os alunos digite 6 \n\nOPÇÃO 7 -Para abrir o menu de turmas digite 7\n")
    print("SAIR -caso deseje sair digite 0")
